...
const categorias = {
	...
	frutas : ["abacaxi", "limão", "abacate", "pessego", "laranja", "uva", "melancia", "mamao", "banana"],
	profissoes : ["engenheiro", "advogado", "medico", "professor", "pescador", "padre"],
	jogadoresinter : ["taison", "cuesta", "edenilson", "patrick", "saravia", "dourado"],
	cores : ["amarelo", "verde", "vermelho", "azul", "roxo", "laranja", "marrom"]
};
...
function verificaFimDeJogo(){
	if(!palavraInterface.innerHTML.includes("-")){
		...
		desenhaOlhos();
		exibePalavraInterface("Você Perdeu! :c");
		window.removeEventListener("keypress", retornaLetra);	
	}
}
